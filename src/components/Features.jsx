        ...
        <section className='max-padd-container py-16'>
            <div className='max-padd-container grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 gap-y-12'>
                <div className='flexCenter flex-col gap-3'>
                    <img src={filter} alt='filter' height={44} width={44}/>
                    <div className='flexCenter flex-col'>
                        <h5 className='h5'>Advanced Search and Filters</h5>
                        <hr className='w-8 bg-secondary h-1 rounded-full border-none'/>
                    </div>
                    <p className='text-center'>
                        Effortessly search books by title, author, genre or price range
                    </p>
                </div>

                <div className='flexCenter flex-col gap-3'>
                    <img src={rating} alt='filter' height={44} width={44}/>
                    <div className='flexCenter flex-col'>
                        <h5 className='h5'>User Review and Ratings</h5>
                        <hr className='w-8 bg-secondary h-1 rounded-full border-none'/>
                    </div>
                    <p className='text-center'>
                        Customes can share reviews, rate books and guide future readers
                    </p>
                </div>

                <div className='flexCenter flex-col gap-3'>
                    <img src={wishlist} alt='filter' height={44} width={44}/>
                    <div className='flexCenter flex-col'>
                ...
                <div className='flexCenter flex-col gap-3'>
                    <img src={secure} alt='filter' height={44} width={44}/>
                    <div className='flexCenter flex-col'>
                        <h5 className='h5'>Secure Online Payments</h5>
                        <hr className='w-8 bg-secondary h-1 rounded-full border-none'/>
                    </div>
                    <p className='text-center'>
                        Enjoy seamless checkout with multiple secure payments options
                    </p>
                </div>
