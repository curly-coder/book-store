        ...
        <section className='absolute top-0 left-0 h-full w-full z-50 bg-white'>
            <div className='flex h-full w-full'>
                ...
                <div className='w-1/2 hidden sm:block'>
                    <img src={loginImg} alt='loginImg' className='object-cover h-full w-full aspect-square'/>
                </div>
                {/*form side*/}
                    ...
                    <form className='flex flex-col items-center w-[90%] sm:max-w-md m-auto gap-y-5 text-gray-800'>
                        ...
                        <div className='w-full flex flex-col gap-y-3 medium-14'>
                            <div className='underline'>
                                ...
                                {currState === 'Login' ? (
                                    <div className='underline'>Don`t have an account? <span onClick={() => setCurrState('Sign Up')} className='cursor-pointer hover:text-secondary'>Create account</span></div>
                                ) : (
                                    <div className='underline'>Already have an account? <span onClick={() => setCurrState('Login')} className='cursor-pointer hover:text-secondary'>Login</span></div>
                                )}
                        </div>
                    </form>
                </div>
